...
$$
\begin{aligned}
P(R) & = P(R \mid A) + P(R \mid B) + P(R \mid C) \\
P(R) & = \frac{P(R \cap A)}{P(A)} + \frac{P(R \cap B)}{P(B)} + \frac{P(R \cap C)}{P(C)} \\
P(R) & = \frac{2 \times 4}{7 \times 10} + \frac{4 \times 1}{5 \times 10} + \frac{1 \times 5}{4 \times 10} = 0.3192857
\end{aligned}
$$
...
$$
\begin{aligned}
P(A \mid R) & = \frac{P(A \cap R)}{P(R)} = 0.8948546
\end{aligned}
$$
